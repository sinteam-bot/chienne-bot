...
db.getDiscordEventsArchive = (opts) => auditRepo.getDiscordEventsArchive(opts);
const { GameStateRepository } = require("../db/schemas/shared/game-state.repository.js");
const gameStateRepo = new GameStateRepository();
db.getCounterState = (id) => gameStateRepo.getCounterState(id);
db.getCountdownScores = (id, limit) => gameStateRepo.getCountdownScores(id, limit);
db.getCountdownState = (id) => gameStateRepo.getCountdownState(id);
