...
CREATE INDEX IF NOT EXISTS "idx_economy_boosts_expires" ON "economy_boosts" USING btree ("expires_at");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "idx_confession_bans_guild" ON "confession_bans" USING btree ("guild_id");--> statement-breakpoint
