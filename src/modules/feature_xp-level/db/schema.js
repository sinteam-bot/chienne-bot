...
module.exports = {
    userXp: pgSchema.userXp,
    xpTransactions: pgSchema.xpTransactions,
    voiceSessions: pgSchema.voiceSessions,
    events: pgSchema.events,
    eventParticipants: pgSchema.eventParticipants,
};
