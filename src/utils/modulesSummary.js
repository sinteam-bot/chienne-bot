...
const CAPTCHA_CONFIG = require('../modules/security_captcha/captcha.config.js');
const WELCOME_CONFIG = require('../modules/welcome_welcome/welcome.config.js');
const XP_CONFIG = require('../modules/engagement_xp-level/xp.config.js');
