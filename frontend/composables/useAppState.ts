...
export function useAppState() {
  ...
  const BOT_SECTION_ITEMS: ChannelItem[] = [
    ...
    { id: 'config', name: 'Configuration Système', icon: '⚙️', routePath: '/config/general', section: 'bot', topic: 'Configuration générale du bot (Tokens, Auth Web, Scheduler, OpenRouter)' }
  ];
