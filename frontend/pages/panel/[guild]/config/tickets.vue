<template>
  ...
  <div v-else class="config-page-wrapper">
    <div class="config-card">
      <div class="card-subtitle">🎫 Système de Tickets de Support</div>
      <p class="config-desc">
        Catégorie d'ouverture, rôles support autorisés, fermeture automatique et transcripts HTML.
      </p>

      <div class="config-item">
        <div class="config-label-group">
          <label class="config-label">Activer le Système de Tickets</label>
          <span class="config-hint">Permet la création de salons privés de support par bouton.</span>
        </div>
        <label class="switch">
      ...
      <div class="config-actions-bar">
        <button class="btn-primary" :disabled="isSaving" @click="saveConfig">
          {{ isSaving ? 'Enregistrement...' : '💾 Sauvegarder Tickets' }}
        </button>
      </div>
    </div>
  </div>
...
useSeoMeta({
  title: 'Tickets de Support - Configuration',
  description: 'Configuration du module de tickets et support'
});
